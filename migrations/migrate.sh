echo "
      ...
      use phpforum;
      source /var/www/migrations/category.sql
      source /var/www/migrations/user.sql
      source /var/www/migrations/question.sql
      source /var/www/migrations/rating.sql
      source /var/www/migrations/answer.sql
